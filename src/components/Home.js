...
const Home = () => {
  ...
  //modal
  const [openModal,setModal] = useState("hidden");

  const change = ()=>{
    if(openModal == "hidden") setModal("visible");
    else setModal("hidden");
  }
    ...
    <div className="bg-gray-100 w-full flex flex-col items-center ">
      ...
      <div className=" storyboard w-4/5 bg-white mb-20 rounded-lg">
        ...
        <div className="grid grid-cols-3">
          ...
          <button
            title="Click to add Storyboard"
            onClick={add}
            className="bg-gray-200 max-w-sm h-[330px] max-h-sm m-10 rounded-lg flex justify-center items-center text-gray-200"
          >
